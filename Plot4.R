...
par(mfrow = c(2,2))
plot(DateTime,TwoDaysData$Global_active_power,type = "l", ylab = "Global Active Power",xlab = "")
plot(DateTime,TwoDaysData$Voltage,type = "l", ylab = "Voltage")
...
plot(DateTime,TwoDaysData$Global_reactive_power,type = "l",ylab = "Global_reactive_power")
dev.off()
